    ...
    <div className="create-account">
      <div className="form-wrapper-container">
        <div className="form-wrapper">
          <h1>REGISTER HERE</h1>
          <h2>
            NOTE : 2 ETH will be deducted from your ethereum wallet.
            when you open an account and this 2 ETH will be deposited 
      ...
      <div className="image-wrapper">
        <img src="./assets/3.svg" className="create-account-image" alt=""/>
      </div>
    </div>
  );
};
