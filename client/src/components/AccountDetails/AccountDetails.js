        ...
        <div className="account-card">
          {!loading ? (
            <div className="inner-wrapper">
              <h1>ACCOUNT-NUMBER : <span className="display">{bankingAccount.serial}</span></h1>
              <h1>ACCOUNT-NAME :  <span className="display">{bankingAccount.name}</span></h1>
              <h1>ACCOUNT-BALANCE :   <span className="display">{bankingAccountBalance} ETH</span></h1>
              <h1>ACCOUNT-LOCATION :  <span className="display">{bankingAccount.location}</span></h1>
              <h1>ACCOUNT-CREATED-AT :   <span className="display">{createdDate} </span></h1>
            </div>
          ) : null}
        </div>
